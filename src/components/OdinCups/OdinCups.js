...
//import OdinCupsStyles from "./OdinCups.css";
...
class OdinCups extends Component {
  constructor() {
    super();
    this.state = {
      coffee: [],
  ...
  componentDidMount() {
    axios.get("http://localhost:3001/api/getOdinCups").then(results => this.setState({ coffee: [...results.data] }));
  }
            ...
            <div className="deathwish-all" key={coffee.coffee_reference}>
              ...
              <div className="coffee-info">
                ...
                <div className="coffee-size-btns">
                  <button>10 PACK</button>
                  <button>20 PACK</button>
                  <button>50 PACK</button>
                </div>
